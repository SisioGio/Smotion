                ...
                <Link to="/albums">
                  <li class="nav-item">
                    <a
                      class="nav-link "
                      onClick={() => (
                        props.setUrl("albums"), setFocus("Albums")
                      )}
                      href="#"
                    >
                      <span
              ...
              {token ? (
                <Link to="/photos">
                  <li class="nav-item">
                    <a
                      onClick={() => (
                        setFocus("Pictures"), props.setUrl("pics")
                      )}
                      class="nav-link "
                      href="#"
                    >
